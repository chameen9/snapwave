                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card overflow-hidden">
                        <div class="bg-login text-center">
                            ...
                            <div class="position-relative">
                                ...
                                <p class="text-white-50 mb-0">Get your free {{ config('app.name') }} account now</p>
                        ...
                        <div class="card-body pt-5">
                            ...
                            <div class="p-2">
                                <form class="form-horizontal" action="{{ route('checkregister') }}">
                                    {{csrf_field()}}
                                    <div class="mb-3">
                    ...
                    <div class="mt-5 text-center">
                        <p>Already have an account ? <a href="{{url('login')}}" class="fw-medium text-primary">
                                Login</a> </p>
                        <p>©
                            <script>document.write(new Date().getFullYear())</script> {{ config('app.name') }}. All right reserved.
                        </p>
                    </div>
